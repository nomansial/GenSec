...
@given(u'FireBase_the user provides the environment details "{env_name}" and "{env_description}"')
...
@when(u'FireBase_the user sends a request to create the environment')
...
@then(u'FireBase_code should be {status_code:d}')
...
@then(u'FireBase_the response should be validated based on error_message {error_message}')
